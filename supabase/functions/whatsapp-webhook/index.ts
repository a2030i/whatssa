  ...
  if (req.method === "POST") {
    try {
      ...
      for (const change of changeItems) {
        ...
        let channelDefaultTeamId: string | null = null;
        let channelDefaultAgentId: string | null = null;
        let channelExcludeSupervisors = false;
        ...
        if (metadataPhoneId) {
          ...
          channelDefaultTeamId = config?.default_team_id || null;
