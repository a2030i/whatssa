...
-- Function to get system-wide stats for super admin
...
-- Function to get hourly message distribution for today
...
-- Function to get per-org usage for capacity planning
CREATE OR REPLACE FUNCTION public.admin_get_top_orgs_usage(_limit int DEFAULT 10)
RETURNS jsonb
LANGUAGE plpgsql
STABLE SECURITY DEFINER
SET search_path TO 'public'
