    ...
    >
      ...
      {(() => {
        ...
        const renderText = (text: string) => {
          ...
          return <p className="leading-[1.65]" style={{ whiteSpace: "pre-wrap", wordBreak: "break-all", overflowWrap: "anywhere", writingMode: "horizontal-tb" }}>{parts.length > 0 ? parts : text}</p>;
        };
